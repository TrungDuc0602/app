class LineProductsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @line_product.save
        format.html { redirect_to @line_product, notice: 'Line product was successfully created.' }
        format.js
  ...
  private
    ...
    def line_product_params
      params.require(:line_product).permit(:product_id, :cart_id, :quantity, :order_id)
    end
end
