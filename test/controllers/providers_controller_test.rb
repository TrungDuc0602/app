...
class ProvidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create provider" do
    assert_difference('Provider.count') do
      post providers_url, params: { provider: { combo_id: @provider.combo_id, product_id: @provider.product_id } }
    end
  ...
  test "should update provider" do
    patch provider_url(@provider), params: { provider: { combo_id: @provider.combo_id, product_id: @provider.product_id } }
